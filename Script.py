...
ʏᴏᴜ ᴄᴀɴ ᴜsᴇ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ɪ ᴡɪʟʟ ɢɪᴠᴇ ʙᴏᴏᴋꜱ ᴀɴᴅ ɴᴏᴠᴇʟꜱ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ !!</b>"""

    HELP_TXT = """<b>Hᴇʏ {}
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""

    ABOUT_TXT = """<b>🤖 Mʏ Nᴀᴍᴇ : {}</b>
<b>🧑 Cʀᴇᴀᴛᴏʀ : <a href=https://t.me/useless07>✭ Iϻsαi🎭Arⱥ𝖘aภ ✭</a></b>
...
🆓 ғʀᴇᴇ sᴛᴏʀᴀɢᴇ: <code>{}</code> 𝙼𝚒𝙱</b>"""
    ...
    LOG_TEXT_G = """#NewGroup
ᴛᴀᴍɪʟʙᴏᴛ Aʟɪᴠᴇ Iɴ Gʀᴏᴜᴘ = {}(<code>{}</code>)
Tᴏᴛᴀʟ Mᴇᴍʙᴇʀs = <code>{}</code>
Aᴅᴅᴇᴅ Bʏ - {}"""

    LOG_TEXT_P = """#NewUser
ᴛᴀᴍɪʟʙᴏᴛ ID - <code>{}</code>
Nᴀᴍᴇ - {}"""

    ALRT_TXT = """ʜᴇʟʟᴏ {},
ᴛʜɪꜱ ɪꜱ ɴᴏᴛ ʏᴏᴜʀ ʙᴏᴏᴋꜱ ᴀɴᴅ ɴᴏᴠᴇʟꜱ ʀᴇQᴜᴇꜱᴛ,
ʀᴇQᴜᴇꜱᴛ ʏᴏᴜʀ'ꜱ..."""
...
🚯 ᴅᴏɴᴛ ᴜꜱᴇ ➠ ':(!,./)</b>"""
    ...
    I_CUD_NT = """ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏ ʙᴏᴏᴋꜱ ᴀɴᴅ ɴᴏᴠᴇʟꜱ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ {}.
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ..."""
    ...
    SHORTLINK_INFO = """
<b>──────「<a href=https://t.me/eTamilBooks/14> 👀ʜᴏᴡ ᴛᴏ ᴜꜱᴇ ᴍᴇ 🤔 </a> 」──────

✯ Wᴀɴᴛ ᴛᴏ Kɴᴏᴡ Hᴏᴡ? Fᴏʟʟᴏᴡ Tʜᴇsᴇ Sᴛᴇᴘs👇:-

➣ ꜰɪʀꜱᴛ ᴊᴏɪɴ <a href=https://t.me/eTamilBooks> 🎖 ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ 📢 </a>
➣ ᴏᴘᴇɴ ᴛʜᴇ <a href=https://t.me/TamilT> 🔍 ʙᴏᴏᴋ ʀᴇQᴜᴇꜱᴛ ɢʀᴏᴜᴘ 🫰 </a> ɢʀᴏᴜᴘ ᴀɴᴅ ꜱᴇɴᴅ ᴛʜᴇ ʙᴏᴏᴋꜱ ɴᴀᴍᴇ
➣ ɴᴀᴍᴇ ᴍᴜꜱᴛ ʙᴇ ᴀ ᴘʀᴏᴘᴇʀ ꜱᴘᴇʟʟɪɴɢ ᴛʜᴇɴ ʙᴏᴛ ᴡɪʟʟ ɢɪᴠᴇ ᴛʜᴇ ʀᴇꜱᴜʟᴛꜱ.
➣ ɴᴏᴡ ꜱᴇʟᴇᴄᴛ ᴀɴʏ ʙᴜᴛᴛᴏɴ ᴡʜɪᴄʜ ʙᴏᴏᴋ ʏᴏᴜ ᴡᴀɴᴛ ᴀɴᴅ ʙᴏᴛ ɴᴏᴡ ꜱᴇɴᴅ ᴛʜᴇ ʟɪɴᴋ ᴛᴏ ʏᴏᴜʀ ᴘᴇʀꜱᴏɴᴀʟ ᴍᴇꜱꜱᴀɢᴇ
➣ ᴏᴘᴇɴ ᴛʜᴇ ʟɪɴᴋ ᴀɴᴅ ᴅᴏᴡɴʟᴏᴀᴅ ᴛʜᴇ ʙᴏᴏᴋ

✯ இந்த வழிமுறைகளை பின்பற்றவும் 👇

➣ முதலில் <a href=https://t.me/eTamilBooks> 📖 ᴛᴀᴍɪʟ ʙᴏᴏᴋ ʜᴏᴜꜱᴇ 📚 </a> முதன்மை சேனலில் சேரவும்
➣ <a href=https://t.me/TamilT>  🌼புத்தக பூக்கள் 🌺 </a> குழுவைத் திறந்து புத்தகக் கோரிக்கை குழுவில் தேவையான புத்தகங்களின் பெயரை அனுப்பவும்
➣ பெயர் சரியான எழுத்துப்பிழையாக இருக்க வேண்டும், பின்னர் போட் முடிவுகளைத் தரும்
➣ இப்போது நீங்கள் விரும்பும் புத்தகத்தைத் தேர்ந்தெடுக்கவும், Bot உங்கள் தனிப்பட்ட செய்திக்கு புத்தக இணைப்பை அனுப்பும்
➣ இணைப்பைத் திறந்து புத்தகத்தைப் பதிவிறக்கவும்

Any Doubts? Contact Me </b>
"""
...
• ꜰᴜʟʟ ɴᴀᴍᴇ : ✭ Iϻsαi🎭Arⱥ𝖘aภ ✭
• ᴜꜱᴇʀɴᴀᴍᴇ :@SaravanaKrish
...
ɪꜰ ʏᴏᴜ ᴅᴏ ɴᴏᴛ ꜱᴇᴇ ᴛʜᴇ ʀᴇǫᴜᴇsᴛᴇᴅ ʙᴏᴏᴋꜱ / ɴᴏᴠᴇʟꜱ ꜰɪʟᴇ, ʟᴏᴏᴋ ᴀᴛ ᴛʜᴇ ɴᴇxᴛ ᴘᴀɢᴇ"""
...
<b>
╭─────── • ◆ • ───────╮
🔅 ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ :  <a href="https://t.me/Tamilmovies4k">Tᴏᴜᴄʜ</a>
╰─────── • ◆ • ───────╯

=========== • ✠ • ===========
▫️ ᴄʜᴀɴɴᴇʟ: @eTamilBooks
▫️ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ: @TamilBookHouse
=========== • ✠ • ===========</b>"""
...
🛠️ ᴛᴀᴍɪʟʙᴏᴛ Bᴜɪʟᴅ Sᴛᴀᴛᴜs: <code>v2.7.1 [ Sᴛᴀʙʟᴇ ]</code></b>"""
